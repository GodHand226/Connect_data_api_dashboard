...
export function Request() {
  ...
  return (
    <div className="pl-4 pt-2">
      ...
      <Snippet
        title="cURL"
        code={`curl -X 'POST' '${API_ENDPOINT}' -H 'accept: application/json' -H 'access_token: ************' -H 'Content-Type: application/json'`}
      ></Snippet>
      <Snippet title="Request URL" code={API_ENDPOINT}></Snippet>
      <Snippet
        title="Request Body"
